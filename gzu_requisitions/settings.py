"""
Django settings for gzu_requisitions project.
"""
...
SECRET_KEY = 'django-insecure-j9sjc%nc2835u@v+sg4+su)$dqj#n%ms*jkogldjfu#4frt1=7'
...
ROOT_URLCONF = 'gzu_requisitions.urls'
...
WSGI_APPLICATION = 'gzu_requisitions.wsgi.application'
